...
import static com.sunilsahoo.tictactoe.model.Player.O;
import static com.sunilsahoo.tictactoe.model.Player.X;
...
public class Board {
     ...
     * Will perform no-op if the arguments are out of range or if that
     * position is already played.
    ...
    /**
     * Algorithm adapted from http://www.ntu.edu
     * .sg/home/ehchua/programming/java/JavaGame_TicTacToe.html
     *
     * @param player
     * @param currentRow
     * @param currentCol
     * @return true if <code>player</code> who just played the move at the
     * <code>currentRow</code>, <code>currentCol</code>
     * has a tic tac toe.
     */
    private boolean isWinningMoveByPlayer(Player player, int currentRow, int
            currentCol) {
