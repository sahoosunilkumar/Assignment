...
import com.sunilsahoo.maplocation.coupon.CouponsFragment;
import com.sunilsahoo.maplocation.deal.DealsFragment;
import com.sunilsahoo.maplocation.maplocator.CouponsLocatorFragment;
...
public class FragmentTabsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTabManager.addTab(host.newTabSpec("coupons").setIndicator("Coupons"),
                CouponsFragment.class, null);
        mTabManager.addTab(host.newTabSpec("deals").setIndicator("Deals"),
                DealsFragment.class, null);
        mTabManager.addTab(host.newTabSpec("map").setIndicator("Map"),
                CouponsLocatorFragment.class, null);
