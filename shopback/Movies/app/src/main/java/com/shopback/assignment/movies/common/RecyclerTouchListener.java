...
/**
 * touch event handler to detect on click and on long click action
 */
public class RecyclerTouchListener implements RecyclerView
        .OnItemTouchListener {
        ...
        gestureDetector = new GestureDetector(context, new
                GestureDetector.SimpleOnGestureListener() {
                    ...
                    public void onLongPress(MotionEvent e) {
                        View child = recyclerView.findChildViewUnder(e
                                .getX(), e
                                .getY());
