...
public class PagerIndicator implements ViewPager.OnPageChangeListener {
    private static final String TAG = PagerIndicator.class.getName();
    ...
    public PagerIndicator(Context context, LinearLayout containerView,
                          ViewPager viewPager, int drawableRes) {
//        Log.d(TAG, "inside constructor start");
        if (context == null) {
            ...
            throw new IllegalArgumentException("ViewPager does not have an " +
                    "adapter set on it.");
        }
        mContext = context;
...
//        Log.d(TAG, "inside constructor end");
    }
...
//        Log.d(TAG, "inside show : "+mInitialPage+" page count : "+mPageCount);
        initIndicators();
