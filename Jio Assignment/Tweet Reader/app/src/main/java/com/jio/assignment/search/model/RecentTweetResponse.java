...
public class RecentTweetResponse implements Parcelable
{
    ...
    @Expose
    private String lang;
    public final static Creator<RecentTweetResponse> CREATOR = new Creator<RecentTweetResponse>() {


        @SuppressWarnings({
            "unchecked"
        })
        public RecentTweetResponse createFromParcel(Parcel in) {
            return new RecentTweetResponse(in);
        }

        public RecentTweetResponse[] newArray(int size) {
            return (new RecentTweetResponse[size]);
        }

    }
    ;

    protected RecentTweetResponse(Parcel in) {
        ...
        this.retweetedStatus = ((RetweetedStatus) in.readValue((RetweetedStatus.class.getClassLoader())));
