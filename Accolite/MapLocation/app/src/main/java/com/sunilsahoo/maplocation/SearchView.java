...
/**
 * Created by sunilkumarsahoo on 11/22/16.
 */
...
public class SearchView extends RelativeLayout implements View.OnClickListener {
    ...
    private void initialize(Context context){
        parentView = LayoutInflater.from(context).inflate(R.layout.search_layout, this);
    ...
    public void onClick(View v) {
        if(searchListener != null){
            searchListener.onSearch(searchText.getText().toString(), parentView);
        }
    }
