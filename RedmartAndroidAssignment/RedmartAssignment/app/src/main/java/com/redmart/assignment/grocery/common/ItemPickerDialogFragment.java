...
public class ItemPickerDialogFragment extends DialogFragment {
    public static final String LOGTAG = "ItemPickerFragment";

    /**
     * An item that can be displayed and selected by the
     * ItemPickerDialogFragment
     */
    public static class Item {
        ...
        /**
         * Get a Bundle of values that can be passed to the Item(Bundle)
         * constructor
        ...
        public static ArrayList<Item> itemsFromBundle(Bundle bundle) {
            ArrayList<Bundle> itemBundles = bundle.getParcelableArrayList
                    (ARG_ITEMS);
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(ItemPickerDialogFragment fragment, Item item, int
                index);
    }
    ...
    /**
     * Create a new instance of ItemPickerDialogFragment with specified
     * arguments
     *
     * @param title         Dialog title text
     * @param items         Selectable items
     * @param selectedIndex initial selection index, or -1 if no item should
     *                      be pre-selected
     * @return ItemPickerDialogFragment
     */
    public static ItemPickerDialogFragment newInstance(String title,
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(title)
                ...
                .setSingleChoiceItems(itemTitles, selectedIndex, new
