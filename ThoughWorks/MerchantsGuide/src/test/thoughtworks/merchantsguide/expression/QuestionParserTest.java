...
public class QuestionParserTest {
	...
	public void ValidationSuccesFor_QuestionPishTegjGlobGlob() {
		...
		String expectedResult = "pish tegj glob glob is 42.0";
		assertTrue(actualResult.equals(expectedResult));
	}
	
	@Test()
	public void ValidationFailureFor_QuestionPishTegjGlobGlob() {
		String actualResult = getResult("how much is pish tegj glob glob glob glob ?");
	...
	public void ValidationSuccesFor_QuestionGlobProkSilver() {
		String actualResult = getResult("how many Credits is glob prok Silver ?");
		String expectedResult = "glob prok Silver is 68.0 Credits";
		assertTrue(actualResult.equals(expectedResult));
	}
	...
	public void ValidationSuccesFor_QuestionGlobProkGold() {
		...
		String expectedResult = "glob prok Gold is 57800.0 Credits";
		assertTrue(actualResult.equals(expectedResult));
	}
	...
	public void ValidationSuccesFor_QuestionGlobProkIron() {
		...
		String expectedResult = "glob prok Iron is 782.0 Credits";
		assertTrue(actualResult.equals(expectedResult));
	}
	
	@Test()
	public void ValidationSuccesFor_QuestionInvalid() {
		String actualResult = getResult("how much wood could a woodchuck chuck if a woodchuck could chuck wood ?");
