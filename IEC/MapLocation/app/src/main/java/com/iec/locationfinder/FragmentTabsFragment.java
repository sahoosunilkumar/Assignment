...
import com.iec.locationfinder.location.SearchFragment;
import com.iec.locationfinder.maplocator.MapLocatorFragment;
...
public class FragmentTabsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_tabs_fragment, container,
                false);
        TabHost host = mTabManager.handleCreateView(v);

        mTabManager.addTab(host.newTabSpec("Details").setIndicator("Details"),
                SearchFragment.class, null);
        mTabManager.addTab(host.newTabSpec("Map").setIndicator("Map"),
                MapLocatorFragment.class, null);
        return v;
    }
    ...
    public static class TabManager implements TabHost.OnTabChangeListener {
        ...
        public TabManager(Context context, FragmentManager manager, int
                containerId) {
            mContext = context;
            mManager = manager;
